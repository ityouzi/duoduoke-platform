...
import com.fulihui.redisdubbo.demo.producer.dal.dao.SignUserCountMapper;
import com.fulihui.redisdubbo.demo.producer.dal.dataobj.SignUserCount;
...
public class SignUserCountRepositoryImpl implements SignUserCountRepository {
    ...
    public SignUserCountDTO query(String userId, Date cycleTime) {
        ...
        if (com.fulihui.redisdubbo.demo.api.util.Collections.isEmpty(list)) {
            return null;
        }
