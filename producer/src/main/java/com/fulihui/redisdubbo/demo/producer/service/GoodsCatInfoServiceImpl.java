...
import com.fulihui.redisdubbo.demo.producer.dal.dao.ExtGoodsCatInfoMapper;
import com.fulihui.redisdubbo.demo.producer.dal.dao.GoodsCatInfoMapper;
...
public class GoodsCatInfoServiceImpl implements GoodsCatInfoService {
    ...
    public TMultiResult<GoodsCatInfoDTO> selectBylevel(GoodsCatInfoRequest request) {
        ...
        if (goodsCatInfos != null) {
            goodsCatInfos.stream().forEach((item) -> {
