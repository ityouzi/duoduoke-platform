...
import com.fulihui.duoduoke.demo.common.config.OSSConfig;
...
public class AliyunOSSClientUtil {
	...
	//阿里云API的bucket名称
	private static String BACKET_NAME ="duoduoke.demo.producer";
	//阿里云API的文件夹名称
	private static String FOLDER ="duoduoke.demo.producer/";

	private static String key ="http://duoduoke.demo.producer.oss-cn-hangzhou.aliyuncs.com/";*/
